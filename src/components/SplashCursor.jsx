...
function SplashCursor({
  ...
  BACK_COLOR = { r: 0.03, g: 0.04, b: 0.08 },
  TRANSPARENT = true
}) {
  ...
  useEffect(() => {
    ...
    function generateColor() {
      const palette = [
        { r: 0.10, g: 0.25, b: 1.00 },  // electric blue
        { r: 0.00, g: 0.65, b: 1.00 },  // cyan blue
        { r: 0.00, g: 0.80, b: 0.85 },  // teal cyan
        { r: 0.00, g: 0.50, b: 1.00 },  // sky blue
        { r: 0.10, g: 0.90, b: 1.00 },  // light cyan
      ];
